$(function () {
    ...
    $.Text_View =
        {
            ...
            {
                'text_link_tabs_cars_list': 'RFID-Карты',
                'text_link_tabs_cars_user': 'Пользователи',
                'field_id': 'id',
    ...
    var lang = $.cookie('lang'),
        ...
        tab_type_cards = {
            ...
            active: 0,
            initObject: function () {
                $('#link-tabs-cars-list').text(langView('text_link_tabs_cars_list', langs));
                $('#link-tabs-cars-user').text(langView('text_link_tabs_cars_user', langs));
                this.html_div.tabs({
                    collapsible: true,
