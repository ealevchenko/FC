        ...
        table_report = {
            ...
            initObject: function () {
                this.obj = $('table#table-report').DataTable({
                    ...
                    //},
                    columns: [
                        { data: "start_datetime", title: langView('field_DateStarted', langs), width: "150px", orderable: true, searchable: false },
                        { data: "tank_num", title: langView('field_TankNo', langs), width: "50px", orderable: true, searchable: true },
                        { data: "oil_type", title: langView('field_OilType', langs), width: "50px", orderable: true, searchable: true },
                        ...
                        { data: "volume", title: langView('field_TargetVolume', langs), width: "50px", orderable: false, searchable: false },
                        { data: "dens", title: langView('field_CreatedDens', langs), width: "50px", orderable: false, searchable: false },
                        { data: "mass", title: langView('field_TargetMass', langs), width: "50px", orderable: false, searchable: false },
                    ],
                    dom: 'Blftipr',
                    buttons: [
                        'copyHtml5',
