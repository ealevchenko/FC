            ...
            initObject: function () {
                this.obj = this.html_table.DataTable({
                    ...
                    "footerCallback": function (row, data, start, end, display) {
                        ...
                        var pipe_a92_mass = (pipe_a92_n * a92_density_avg) * 0.001;
                        var pipe_a95_mass = (pipe_a95_n * a95_density_avg) * 0.001;
                        var pipe_dt_mass = (pipe_dt_n * dt_density_avg) * 0.001;
                        var pipe_kerosin_mass = (pipe_kerosin_n * kerosin_density_avg) * 0.001;
