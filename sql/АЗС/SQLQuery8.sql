...
/****** Object:  UserDefinedFunction [dbo].[split]    Script Date: 15.02.2020 22:19:23 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [dbo].[get_DADR_AZS] 
 (
	@start datetime,
	@stop datetime,
	@type int
...
SELECT 
  ...
  select 
      ...
      ,[mass15_remains_stop]
	  ,[allowable_volume15_error] = (([volume15_remains_start]-[volume15_delivery]+[volume15_received]-[volume15_remains_stop])/[volume15_remains_stop])*100
	  ,[absolute_volume15_error] = ([volume15_remains_start]-[volume15_delivery]+[volume15_received]-[volume15_remains_stop])
	  ,[allowable_mass15_error] = (([mass15_remains_start]-[mass15_delivery]+[mass15_received]-[mass15_remains_stop])/[mass15_remains_stop])*100
